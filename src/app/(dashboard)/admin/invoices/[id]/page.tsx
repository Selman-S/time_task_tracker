...
export default function InvoiceDetailPage() {
  ...
  const fetchInvoice = async () => {
    try {
      ...
      if (data.success) {
        console.log('Setting invoice data:', data.data); // Debug log
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Period Start</h4>
                    <p className="text-gray-900">{formatDate(invoice.periodStart)}</p>
                  </div>
                  <div>
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Period End</h4>
